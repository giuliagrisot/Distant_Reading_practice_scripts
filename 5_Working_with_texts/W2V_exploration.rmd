...
# we have a model so i substituted all 'demo_vectors' with 'model' here onwards (GG)
...
# model %>% closest_to(model[["good"]]+model[["bad"]])
```
...
model[[c("lady","woman","man","he","she","guy","man"), average=F]] %>% 
  plot(method="pca")
